                            ...
                            <li>
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add-book.php">Add Book</a></li>
                                     ...
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="book-request.php">Book Requests</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="mail-student.php">Mail Student</a></li>
                                </ul>
                            </li>
